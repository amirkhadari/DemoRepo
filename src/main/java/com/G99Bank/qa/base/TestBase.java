...
public class TestBase {
	...
	public TestBase(){
		...
		prop = new Properties();
		try {
			FileInputStream ip = new FileInputStream("/home/innoraft/Amir/eclipse-oxygen-workspace/G99BankTest/"
					+ "src/main/java/com/G99Bank/qa/config/config.properties");
